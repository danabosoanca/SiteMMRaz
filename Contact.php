...
<html style="font-size: 16px;">
  <head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="Aici ne găsești">
...
<link rel="stylesheet" href="Contact.css" media="screen">
  ...
  <body class="u-body"><header class="u-align-left u-clearfix u-header u-palette-4-base u-header" id="sec-508d"><nav class="u-align-center u-menu u-menu-dropdown u-offcanvas u-menu-1">
        ...
        <div class="u-custom-menu u-nav-container">
          <li class="u-nav-item"><a
              ...
              href="Home.html" style="padding: 22px 18px;">Acasă</a>
          </li>
          <li class="u-nav-item"><a
              class="u-border-2 u-border-active-palette-1-base u-border-hover-palette-1-base u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-text-active-palette-1-base u-text-grey-90 u-text-hover-grey-90"
              href="Etape.html" style="padding: 22px 18px;">Etape</a>
          
          </li>
          <li class="u-nav-item"><a
              class="u-border-2 u-border-active-palette-1-base u-border-hover-palette-1-base u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-text-active-palette-1-base u-text-grey-90 u-text-hover-grey-90"
              href="Echipa.html" style="padding: 22px 18px;">Echipă</a>
          </li>
        ...
        <div class="u-custom-menu u-nav-container-collapse">
          <div class="u-black u-container-style u-inner-container-layout u-opacity u-opacity-65 u-sidenav">
            ...
            <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-2"><li class="u-nav-item"><a class="u-button-style u-nav-link" href="Home.html" style="padding: 22px 18px;">Acasă</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="Etape.html" style="padding: 22px 18px;">Etape</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="Echipa.html" style="padding: 22px 18px;">Echipa</a>
    ...
    <section class="u-align-center u-clearfix u-section-1" id="sec-e89a">
      <div class="u-clearfix u-sheet u-sheet-1">
        <p class="u-text u-text-default u-text-1">Vă putem oferi asistență pe durata întregului proces de înființare a SRL-ului pentru doar 800 de lei</p>
        <p class="u-text u-text-default u-text-1">În plus, dacă apelezi la serviciile noastre până în luna decembrie, poți beneficia de o reducere de 15%</p>
        <div class="u-clearfix u-expanded-width u-layout-wrap u-layout-wrap-1">
          <div class="u-gutter-0 u-layout">
            <div class="u-layout-row">
              <div class="u-align-left u-container-style u-layout-cell u-left-cell u-size-30 u-layout-cell-1">
                <div class="u-container-layout u-container-layout-1">
                  <h2 class="u-text u-text-grey-70 u-text-2">Aici ne găsești</h2>
                  <p class="u-text u-text-grey-50 u-text-3">Bd. Ferdinand I, sector 2, București,România<br>
                    <br>Luni –Vineri: 9:00 – 17:00<br>
                    <br>infiintaresrl<a href="#" target="_blank">@yahoo.com</a>
                  </p>
              ...
              <div class="u-align-left u-container-style u-layout-cell u-right-cell u-size-30 u-layout-cell-2">
                <div class="u-container-layout u-valign-middle u-container-layout-2">
                  <div class="u-expanded-width u-form u-form-1">
                    ...
                    <form action="contactform.php" method="POST" class="u-clearfix u-form-spacing-28 u-form-vertical u-inner-form" style="padding: 17px;" source="customphp" name="form">
                      <div class="u-form-group u-form-name u-form-group-1">
                        
                        <input type="text" placeholder="Nume" id="name-3b9a" name="name" class="u-border-2 u-border-black u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-input-1" required="">
                      </div>
                      <div class="u-form-email u-form-group u-form-group-2">
                        
                        <input type="email" placeholder="Adresa de email" id="email-3b9a" name="email" class="u-border-2 u-border-black u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-input-2" required="">
                      </div>
                      <div class="u-form-group u-form-message u-form-group-3">
                        
                        <textarea placeholder="Mesaj" rows="4" cols="50" id="message-3b9a" name="msg" class="u-border-2 u-border-black u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-input-3" required=""></textarea>
                      </div>
                      <div class="u-align-left u-form-group u-form-submit u-form-group-4">
                       
                        <input type="submit" class="u-btn u-btn-submit u-button-style u-hover-palette-4-base u-text-hover-palette-3-base u-btn-1" value="cumpără" class="u-form-control-hidden">
                      </div>
